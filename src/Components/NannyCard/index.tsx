      ...
      <div className="max-w-xs bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="px-5 pb-5">
          <a href="ps">
            ...
            <p>25 years Experience as Nanny </p>
            <p>Full time </p>
            <p>45 years </p>
          </a>
          <div className="flex items-center mt-2.5 mb-5">
            ...
            <span className="bg-red-300 text-red-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-300 dark:text-red-800 ml-3">
              5.0
            </span>
          </div>
